...
import ImpactList from "./ImpactList/index";
import StackChips from "./StackChips/index";
...
export default function Chapter({
  ...
  return (
    <motion.div className={styles["exp-chapter"]} style={{ opacity, pointerEvents }}>
      <div className={styles["exp-chapter-inner"]}>
        <Lanyard item={item} index={index} dropReady={dropReady} />

        <motion.div
          className={styles["exp-copy"]}
          style={{ y: copyY }}
          variants={copyContainer}
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
        >
          <motion.h3 className={styles["exp-company"]} variants={copyItem}>
          ...
          <motion.p className={styles["exp-role"]} variants={copyItem}>
            {item.role}
          </motion.p>
          <motion.p className={styles["exp-summary"]} variants={copyItem}>
            {segments.map((seg2, i) =>
              seg2.accent === null ? (
          ...
          <motion.div className={styles["exp-block"]} variants={copyItem}>
