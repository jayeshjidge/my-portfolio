...
import ContactIntro from "./Intro/ContactIntro/index";
...
export default function Contact() {
  ...
  return (
    <section className={styles.contact} id="contact" data-nav-offset="0" aria-label="Contact">
      <div className={styles["contact-inner"]}>
        <div className={styles["contact-grid"]}>
          <motion.div
            ref={leftRef}
            className={styles["contact-left"]}
          ...
          >
            ...
            <motion.ul className={styles["contact-rows"]} variants={leftItem(Boolean(reduce))}>
              {rowItems}
            </motion.ul>

            <motion.p className={styles["contact-signoff"]} variants={leftItem(Boolean(reduce))}>
