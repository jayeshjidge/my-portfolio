...
export default function WorkNote() {
  const rows = ITEMS.map((t) => (
    <li key={t} className="wnote-item">
      <span className="wnote-check" aria-hidden="true">
  ...
  return (
    <div className="wnote">
      <span className="wnote-tape" aria-hidden="true" />
      <h3 className="wnote-title">Let&apos;s work together</h3>
      <ul className="wnote-list">{rows}</ul>
      <span className="wnote-face" aria-hidden="true">
