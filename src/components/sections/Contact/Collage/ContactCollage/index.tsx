...
import WorkNote from "../WorkNote/index";
import LearningNote from "../LearningNote/index";
...
export default function ContactCollage() {
  ...
  const arrow1 = (
    <span className={`${styles["cr-conn"]} ${styles["cr-conn--1"]}`} aria-hidden="true">
  ...
  const arrow2 = (
    <span className={`${styles["cr-conn"]} ${styles["cr-conn--2"]}`} aria-hidden="true">
  ...
  return (
    <motion.div
      ref={ref}
      className={styles["cr-stage"]}
      variants={collageGroup(reduce)}
      initial="hidden"
      animate={inView ? "visible" : "hidden"}
    >
      <ParallaxItem px={px} py={py} depth={34} reduce={reduce} className={`${styles["cr-cross"]} ${styles["cr-cross--a"]}`}>
        <span className={styles["cr-cross-mark"]} aria-hidden="true">+</span>
      </ParallaxItem>
      <ParallaxItem px={px} py={py} depth={30} reduce={reduce} className={`${styles["cr-cross"]} ${styles["cr-cross--b"]}`}>
        <span className={styles["cr-cross-mark"]} aria-hidden="true">+</span>
      </ParallaxItem>
      ...
      <ParallaxItem px={px} py={py} depth={20} reduce={reduce} className={styles["cr-build"]}>
        <BuildCard />
      </ParallaxItem>
    </motion.div>
  );
