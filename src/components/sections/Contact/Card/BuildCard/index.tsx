...
export default function BuildCard() {
  return (
    <div className={styles["build-wrap"]}>
      <span className={styles["build-stack"]} aria-hidden="true" />
      <div className={styles["build-card"]}>
        <div className={styles["build-bar"]} aria-hidden="true">
          <i />
          <i />
          <i />
        </div>
        <div className={styles["build-preview"]} aria-hidden="true">
          <span className={styles["build-sun"]} />
          <svg className={styles["build-wave"]} viewBox="0 0 260 92" preserveAspectRatio="none">
            <path
